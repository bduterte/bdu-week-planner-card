                            ...
                            ${day.events.length === 0 ?
                                ...
                                html`
                                    ${day.events.map((event) => {
                                        return html`
                                            <div class="event ${event.class}" data-entity="${event.calendar}" style="background-color: ${event.bgcolor}; --border-color: ${event.color}" @click="${() => { this._handleEventClick(event) }}">
                                                <div class="time">
                                                    ${event.fullDay ?
